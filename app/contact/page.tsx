        ...
        <div className="container-custom">
          <div className="text-center mb-20">
            <div className="inline-block mb-4 px-6 py-2 rounded-full glass-card">
              <span className="text-primary-red font-medium">📞 Get In Touch</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="glass-card p-8">
              ...
              {submitted ? (
                <div className="bg-primary-red/10 border border-primary-red/30 rounded-2xl p-6 text-center">
                  <svg className="w-16 h-16 text-primary-red mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-8">
              <div className="glass-card p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary-red to-primary-crimson rounded-xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-brand-silver to-brand-gray rounded-xl flex items-center justify-center flex-shrink-0">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary-crimson to-primary-dark rounded-xl flex items-center justify-center flex-shrink-0">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-brand-gray to-brand-lightgray rounded-xl flex items-center justify-center flex-shrink-0">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="glass-card p-8">
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/marionn_autos/?hl=en" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary-red hover:border-primary-red hover:scale-110 transition-all duration-300">
                  ...
                  <a href="https://snapchat.com/add/Marionautos" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary-red hover:border-primary-red hover:scale-110 transition-all duration-300">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://wa.me/233207946778" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary-red hover:border-primary-red hover:scale-110 transition-all duration-300">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
