        ...
        <div className="container-custom">
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-white/60">Join Marion Autos today</p>
            </div>
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="flex items-start gap-3 cursor-pointer">
                      <input
                        type="checkbox"
                        className="mt-1 w-4 h-4 rounded border-white/20 bg-white/5 text-primary-red focus:ring-primary-red focus:ring-offset-0"
                        required
                      />
                      <span className="text-white/60 text-sm">
                        I agree to the{' '}
                        <Link href="/terms" className="text-primary-red hover:text-primary-crimson transition-colors">
                          Terms of Service
                        </Link>
                        {' '}and{' '}
                        <Link href="/privacy" className="text-primary-red hover:text-primary-crimson transition-colors">
                          Privacy Policy
                        </Link>
                      </span>
                    </label>
                ...
                <div className="mt-8 text-center">
                  <p className="text-white/60">
                    ...
                    <Link href="/login" className="text-primary-red hover:text-primary-crimson font-medium transition-colors">
                      Sign in
                    </Link>
                  </p>
                </div>
